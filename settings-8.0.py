...
ENV_NAME = os.environ.get("ENV_NAME", "fuel_system_test_8")
...
# The following is not true, and neither is the illusion that other
#   subnets work....
...
EXTERNAL_DNS = os.environ.get('EXTERNAL_DNS', '8.8.8.8')
EXTERNAL_NTP = os.environ.get('EXTERNAL_NTP', 'pool.ntp.org')
...
DATERA_PLUGIN_PATH = os.environ.get('DATERA_PLUGIN_PATH')
DATERA_MVIP = os.environ.get('DATERA_MVIP')
DATERA_USERNAME = os.environ.get('DATERA_USERNAME')
DATERA_PASSWORD = os.environ.get('DATERA_PASSWORD')
DATERA_NUM_REPLICAS = os.environ.get('DATERA_NUM_REPLICAS')
